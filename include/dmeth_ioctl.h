 ...
 * instead of only through a direct dmeth_port_* call with a hand-built
 * config (see tests/dmeth_test.c). Must be set before
 * DMDRVI_IOCTL_NET_START, same restriction as dmeth_port_set_loopback_mode()
 * itself.
 */
