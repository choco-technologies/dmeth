...
dmod_dmeth_api_declaration(1.0, dmeth_t, _create, ( void ))
{
    ...
    struct dmeth *instance = Dmod_Malloc(sizeof(*instance));
    if (instance == NULL)
    {
        return NULL;
    }
...
dmod_dmeth_api_declaration(1.0, void, _destroy, ( dmeth_t handle ))
{
    Dmod_Free(handle);
}

dmod_dmeth_api_declaration(1.0, bool, _is_valid, ( dmeth_t handle ))
{
